...
Benchmark.bm(18) do |x|
  ...
  puts("\n")
  puts("MD5:               #{"%10.0f" % (n / t_md5.real)} ops/sec")
  puts("SHA-1:             #{"%10.0f" % (n / t_sha1.real)} ops/sec")
  puts("native FNV A 32:   #{"%10.0f" % (n / t_fnv_a_32.real)} ops/sec")
  puts("native FNV A 64:   #{"%10.0f" % (n / t_fnv_a_64.real)} ops/sec")
  puts("native FNV B 32:   #{"%10.0f" % (n / t_fnv_b_32.real)} ops/sec")
  puts("native FNV B 64:   #{"%10.0f" % (n / t_fnv_b_64.real)} ops/sec")
  puts("ffi FNV 32:        #{"%10.0f" % (n / t_fnv_ffi_32.real)} ops/sec")
  puts("ffi FNV 64:        #{"%10.0f" % (n / t_fnv_ffi_64.real)} ops/sec")
  puts("direct ffi FNV 32: #{"%10.0f" % (n / t_fnv_dffi_32.real)} ops/sec")
  puts("direct ffi FNV 64: #{"%10.0f" % (n / t_fnv_dffi_64.real)} ops/sec")
  puts("ext FNV 32:        #{"%10.0f" % (n / t_fnv_ext_32.real)} ops/sec")
  puts("ext FNV 64:        #{"%10.0f" % (n / t_fnv_ext_64.real)} ops/sec")
end
